...
[![GoDoc](https://godoc.org/github.com/julymetodiev/go-binance?status.svg)](https://godoc.org/github.com/julymetodiev/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/julymetodiev/go-binance)](https://goreportcard.com/report/github.com/julymetodiev/go-binance)
...
```shell
go get github.com/julymetodiev/go-binance
```
...
```golang
import (
    "github.com/julymetodiev/go-binance"
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/julymetodiev/go-binance) for full references.
